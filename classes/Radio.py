...
class Radio:
    ...
    async def start_radio(self, station_id, station_from) -> Track:
        self.station_id = station_id
        self.station_from = station_from

        # get first 5 tracks
        await self.__update_radio_batch(None)
    ...
    async def play_next(self) -> Track:
        ...
        if self.index >= len(self.station_tracks.sequence):
            ...
            await self.__update_radio_batch(self.current_track.track_id)
